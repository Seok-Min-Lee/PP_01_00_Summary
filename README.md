# 하이커그라운드-비하인더씬(Behind The Scene)
[한국관광공사 하이커그라운드](https://korean.visitkorea.or.kr/detail/rem_detail.do?cotid=8653d837-4660-46a2-a419-7b470d89a70c#about)에서 진행중인 한국 문화 콘텐츠를 AI, XR 기술을 활용한 체험형 콘텐츠 중심 전시입니다.
Behind The Scene은 해당 전시 콘텐츠 중 한국식 메이크업을 주제로 한 체험형 인터랙티브 콘텐츠로 한국 문화 요소를 시각적·체험적으로 전달하는 것을 목표로 합니다.
이 콘텐츠는 여러 대의 키오스크와 디스플레이가 하나의 체험 흐름으로 동작하도록 설계되었으며 얼굴 인식, 이미지 합성, 네트워크 기반 데이터 연동을 통해 전시 환경에서도 안정적으로 운영될 수 있도록 구현되었습니다.
